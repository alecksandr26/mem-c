...
/* TODO: Make better checksum to avoid possibly overwrites from the user */
...
extern void *mem_copy(void * restrict dest, const void * restrict src, unsigned long nbytes);
